...
output_base_path = "/data/yangchangfan/DiffusionPDE/data/TE_heat-merged/merge_{}.npy"
...
for i in range(number):
    ...
    # T 
    path_T = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat/T/", f'{i+1}.mat')
