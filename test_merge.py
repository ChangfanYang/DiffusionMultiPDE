...
# file_path = "/data/yangchangfan/DiffusionPDE/data/Elder_wrong_1-merged/merge_1.npy"
# data = np.load(file_path)

# # Check the shape and content
# print("Array shape:", data.shape)
# print("Data type:", data[:,:,2])
# print("Min value:", np.min(data[:,:,1]))
# print("Max value:", np.max(data[:,:,1]))
...
data_Elder = np.load("/data/yangchangfan/DiffusionPDE/data/Elder_wrong_1-merged/merge_2.npy")
