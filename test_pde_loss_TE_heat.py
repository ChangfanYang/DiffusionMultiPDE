...
boundary_mask = get_boundary_points(128,device=device)
...
L_obs_BC_T = torch.norm(pde_loss_BC_T, 2)/(128+128+128+128-4)
...
plt.imshow(pde_loss_E_np.real, cmap='viridis')  # 使用 viridis 色彩映射
plt.colorbar()  # 添加颜色条
