...
output_base_path = "/data/yangchangfan/DiffusionPDE/data/Elder_wrong-merged/merge_{}.npy"
...
range_allu_u = sio.loadmat(os.path.join(data_base_path, "u_u/range_allu_u.mat"))['range_allu_u']
range_allu_v = sio.loadmat(os.path.join(data_base_path, "u_v/range_allu_v.mat"))['range_allu_v']
range_allc_flow = sio.loadmat(os.path.join(data_base_path, "c_flow/range_allc_flow.mat"))['range_allc_flow']
...
for i in range(1, num_samples + 1):
    ...
    for t in range(0, time_steps ):
        ...
        for var_idx, var in enumerate(var_names):
            min_val = ranges[var][0,0]
            max_val = ranges[var][0,1]
