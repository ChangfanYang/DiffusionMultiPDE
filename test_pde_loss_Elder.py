...
def get_Elder_loss(rho_water, p_t, Sxx, Sxy, Syy, x_u, x_v, rho_water_GT, p_t_GT, Sxx_GT, Sxy_GT, Syy_GT, x_u_GT, x_v_GT, rho_water_mask, p_t_mask, Sxx_mask, Sxy_mask, Syy_mask, x_u_mask, x_v_mask, device=torch.device('cuda')):
...
plt.colorbar()  # 添加颜色条
plt.title('Elder Loss for AC_real')
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elder _loss_AC_real.png')  # 保存为 PNG 文件

plt.figure(figsize=(8, 6))
plt.imshow(pde_loss_AC_imag_np, cmap='viridis')  # 使用 viridis 色彩映射
plt.colorbar()  # 添加颜色条
plt.title('Elder Loss for AC_imag')
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elderloss_AC_imag.png')  # 保存为 PNG 文件
...
plt.colorbar()
plt.title('Elder Loss structure_real_x')
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elderloss_structure_real_x.png')  # 保存为 PNG 文件


plt.figure(figsize=(8, 6))
plt.imshow(pde_loss_structure_imag_x_np, cmap='viridis')  # 使用相同的色彩映射
plt.colorbar()
plt.title('Elderloss_structure_imag_x')
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elderloss_structure_imag_x.png')  # 保存为 PNG 文件
...
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elderloss_structure_real_y.png')  # 保存为 PNG 文件


plt.figure(figsize=(8, 6))
plt.imshow(pde_loss_structure_imag_y_np, cmap='viridis')  # 使用相同的色彩映射
plt.colorbar()
plt.title('Elderloss_structure_imag_y')
plt.xlabel('X-axis')
plt.ylabel('Y-axis')
plt.savefig('Elderloss_structure_imag_y.png')  # 保存为 PNG 文件
