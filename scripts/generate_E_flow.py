...
def generate_E_flow(config):
    ...
    # scale zeta
        ...
        if i <= 0.9 * num_steps:
            ...
            x_next = x_next - 0.8*(zeta_obs_kappa * grad_x_cur_obs_kappa + zeta_obs_ec_V * grad_x_cur_obs_ec_V + zeta_obs_u_flow * grad_x_cur_obs_u_flow + zeta_obs_v_flow * grad_x_cur_obs_v_flow ) - 0.1* (zeta_pde_NS * grad_x_cur_pde_NS + zeta_pde_J * grad_x_cur_pde_J)
