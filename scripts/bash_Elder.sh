...
# 修改此处
echo "start to test Elder"
PYTHON_SCRIPT="/home/yangchangfan/anaconda3/envs/DiffusionPDE/bin/python3 /home/yangchangfan/CODE/DiffusionPDE/generate_pde.py --config /home/yangchangfan/CODE/DiffusionPDE/configs/Elder.yaml"


# 配置参数（你可以根据需要修改这些值）
START_ID=1001
END_ID=1101
BATCH_SIZE=13     # 每个子任务处理多少个样本
