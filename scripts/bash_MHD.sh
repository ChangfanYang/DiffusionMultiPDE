...
# 修改此处
echo "start to test MHD"
PYTHON_SCRIPT="/home/yangchangfan/anaconda3/envs/DiffusionPDE/bin/python3 /home/yangchangfan/CODE/DiffusionPDE/generate_pde.py --config /home/yangchangfan/CODE/DiffusionPDE/configs/MHD.yaml"


# 配置参数（你可以根据需要修改这些值）
START_ID=10001
END_ID=11000
BATCH_SIZE=170     # 每个子任务处理多少个样本
# GPUS=(1 3 2 4)      # 使用的 GPU 编号（可以是任意顺序）
GPUS=(1 2 3 4 5 6)      # 使用的 GPU 编号（可以是任意顺序）
gpu_count=6
