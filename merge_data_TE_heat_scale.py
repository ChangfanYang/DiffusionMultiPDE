...
output_base_path = "/data/yangchangfan/DiffusionPDE/data/TE_heat_scale-merged/merge_{}.npy"
...
for i in range(number):
    ...
    # load mater
    # load poly
    path_mater = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat_scale/mater/", f'{i+1}.mat')
...
# output material  Re(Ez) Im(Ez) T
    # load max_abs_Ez
max_abs_Ez_path = "/data/yangchangfan/DiffusionPDE/data/training/TE_heat_scale/Ez/max_abs_Ez.mat"
max_abs_Ez = sio.loadmat(max_abs_Ez_path)['max_abs_Ez']

print(max_abs_Ez)

    # load T
range_allT_paths = "/data/yangchangfan/DiffusionPDE/data/training/TE_heat_scale/T/range_allT.mat"
...
for i in range(number):
    # Ez 
    path_Ez = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat_scale/Ez/", f'{i+1}.mat')
    ...
    # T 
    path_T = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat_scale/T/", f'{i+1}.mat')
