...
output_base_path = "/data/yangchangfan/DiffusionPDE/data/Darcy-merged/merge_{}.npy"
...
for j in range(1, 6):
    ...
    training_raw_data = sio.loadmat(f"/data/yangchangfan/DiffusionPDE/data/training/darcy/darcy_{j}.mat")
