...
torchrun --standalone --nproc_per_node=1 train.py --outdir=pretrained-darcy-new --data=/data/yangchangfan/DiffusionPDE/data/Darcy-merged/ --cond=0 --arch=ddpmpp --batch=1 --batch-gpu=1 --tick=10 --snap=50 --dump=100 --duration=20 --ema=0.05
```

 CUDA_VISIBLE_DEVICES=0,1,2,3,4 torchrun --standalone --nproc_per_node=5 train.py --outdir=/home/yangchangfan/CODE/DiffusionPDE/pretrained-TE_heat/ --data=/data/yangchangfan/DiffusionPDE/data/TE_heat-merged/ --cond=0 --arch=ddpmpp --batch=60 --batch-gpu=12 --tick=10 --snap=50 --dump=100 --duration=5 --ema=0.05
