...
output_base_path = "/data/yangchangfan/DiffusionPDE/data/TE_heat_sigl_E-merged/merge_{}.npy"
...
for i in range(number):
    ...
    # load mater
    # load poly
    path_mater = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat/mater/", f'{i+1}.mat')
...
for i in range(number):
    # Ez 
    path_Ez = os.path.join(f"/data/yangchangfan/DiffusionPDE/data/training/TE_heat/Ez/", f'{i+1}.mat')
